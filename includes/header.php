      ...
      <ul class="nav navbar-nav navbar-right">        
        ...
        <li class="dropdown" id="navOrder">
          ...
          <ul class="dropdown-menu">            
            <li id="topNavAddOrder"><a href="addOrder.php"> <i class="glyphicon glyphicon-plus"></i> Agregar Ventas</a></li>            
            <li id="topNavManageOrder"><a href="orders.php?o=manord"> <i class="glyphicon glyphicon-edit"></i> Gestionar Ventas</a></li>            
          </ul>
        </li> 
